...
import { fetchRequests } from "@/services/campaign.service";
...
export default function Requests() {
    ...
    const handleRequests = async () => {
        await fetchRequests(signer, setRequests);
        setIsLoading(false)
    }

    useEffect(() => {
        if (thisCampaign?.balance == 0) {
                        ...
                        >
                            <SimpleGrid row spacing={2} align="center">
                                ...
                                <Heading
                                    ...
                                    size="md"
                                >
                                    No Requests yet for {thisCampaign?.name} Campaign
                                </Heading>
                                <Text
                                ...
                                >
                                    <NextLink href={`/campaign/requests/${id}/new`}>
